...
<section id="sign-up">
        ...
        <div class="container">
                ...
                <form method="post" action="<?php echo base_url; ?>DB/insertcourses.php" enctype='multipart/form-data'>
                    ...
                    <input type="number" placeholder="Price of Course" name="price" required="">
